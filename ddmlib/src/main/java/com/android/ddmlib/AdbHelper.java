...
public final class AdbHelper {
     ...
     *
     * @param adbSockAddr
     * @param device      the device to connect to. Can be null in which case the
    ...
    /**
     * @deprecated Use
     * {@link #executeRemoteCommand(java.net.InetSocketAddress, IDevice, IShellOutputReceiver, long, java.util.concurrent.TimeUnit, String, String...)}.
     */
    @Deprecated
    static void executeRemoteCommand(InetSocketAddress adbSockAddr, IDevice device,
                                     IShellOutputReceiver rcvr, int maxTimeToOutputResponse, String command, String... args)
            throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException {
        executeRemoteCommand(adbSockAddr, device, rcvr, maxTimeToOutputResponse, TimeUnit.MILLISECONDS, command, args);
    }
     ...
     * @throws TimeoutException                  in case of timeout on the connection when sending the
     *                                           command.
     * @throws AdbCommandRejectedException       if adb rejects the command
     * @throws ShellCommandUnresponsiveException in case the shell command doesn't send any output for a
     *                                           period longer than <var>maxTimeToOutputResponse</var>.
     * @throws IOException                       in case of I/O error on the connection.
     * @see DdmPreferences#getTimeOut()
     */
    static void executeRemoteCommand(InetSocketAddress adbSockAddr, IDevice device,
                                     IShellOutputReceiver rcvr, long maxTimeToOutputResponse, TimeUnit maxTimeUnits, String command, String... args)
            throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException {
        executeRemoteCommand(adbSockAddr, AdbService.SHELL, device, rcvr, maxTimeToOutputResponse,
                maxTimeUnits, null /* inputStream */, command, args);
    }
     ...
     *
     * @param adbSockAddr             the {@link InetSocketAddress} to adb.
     * @param adbService              the {@link com.android.ddmlib.AdbHelper.AdbService} to use to
     *                                run the command.
     * @param command                 the shell command to execute
     * @param device                  the {@link IDevice} on which to execute the command.
     * @param rcvr                    the {@link IShellOutputReceiver} that will receives the output
    ...
    static void executeRemoteCommand(InetSocketAddress adbSockAddr, AdbService adbService,
                                     ...
                                     @Nullable InputStream is, String command, String... args)
            throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException {
     ...
     * @param localPortSpec  specification of the local port to forward, should be of
     ...
     * @param localPortSpec  specification of the local port that was forwarded, should be
     ...
     * Reboot the device.
     *
     * @param into what to reboot into (recovery, bootloader). Or null to just
     *             reboot.
     * @throws TimeoutException            in case of timeout on the connection.
     * @throws AdbCommandRejectedException if adb rejects the command
     * @throws IOException                 in case of I/O error on the connection.
